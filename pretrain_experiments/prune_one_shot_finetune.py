...
def prune_finetune(sparsity):
    subprocess.call([
        ...
        "--output_dir", os.path.join(OUTPUT_DIR, f"base_prune_{int(sparsity*100)}"),
        "--do_train", "True",
        "--do_eval", "True",
        ...
        "--num_warmup_steps", "10",
        "--learning_rate", "2e-5",
        '--pruning_hparams', f'initial_sparsity={sparsity},target_sparsity={sparsity},sparsity_function_end_step=1,end_pruning_step=200'
    ])
